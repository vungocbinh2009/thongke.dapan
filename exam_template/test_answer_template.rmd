...
Lưu ý: Đoạn code dưới đây có thể chạy trong RStudio nhưng không chạy được trong PyCharm. Để chạy, đặt eval = TRUE
```{r, eval = FALSE}
# Install devtools
...
answer_1 <- estimate_mean_norm(sigma = 3, n = 36, alpha = 0.05, mean = 66, mode = "two.side") %>%
  answer_estimate_mean_norm(
    sd_symbol = "\\sigma",
    answer = "Khoảng tin cậy 95\\% là:",
  )

answer_2 <- test_mean_norm(sigma = 5.2, alpha = 0.05, n = 100, mean = 27.56, mean_0 = 26, mode = "neq") %>%
